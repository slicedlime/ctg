...
execute if entity @a[tag=_ctg_l7e7_check] run kill @e[type=creeper,tag=_ctg_l7e7_creeper_miss]

tag @a remove _ctg_l7e7_check
execute if block 97 115 -46 command_block if score CommandExecuted _ctg_scratch matches 1 run function ctg:lesson7/exercise7_check
