...
scoreboard players set L7E10Check _ctg_main 1
...
setblock 1025 10 1024 chain_command_block{auto:1b,Command:"function ctg:lesson7/exercise10_tick_check"}

summon rabbit 1024 20 1024 {NoAI:1,Tags:["_ctg_l7e10_test_rabbit"]}
