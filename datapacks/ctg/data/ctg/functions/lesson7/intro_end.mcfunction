...
execute if score Lesson _ctg_main matches 7 if score Exercise _ctg_main matches 0 run scoreboard players set Lesson _ctg_scratch 7
execute if score Lesson _ctg_main matches 7 if score Exercise _ctg_main matches 0 run scoreboard players set Exercise _ctg_scratch 1
execute if score Lesson _ctg_main matches 7 if score Exercise _ctg_main matches 0 run scoreboard players set Tick _ctg_scratch 0
execute if score Lesson _ctg_main matches 7 if score Exercise _ctg_main matches 0 run function ctg:store
