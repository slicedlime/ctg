...
execute if score Lesson _ctg_main matches 7 if score Exercise _ctg_main matches 5 if score L7E10Check _ctg_main matches 100 if score L7E10Score _ctg_main matches 5..95 run scoreboard players set Completed _ctg_scratch 1
...
execute if score Completed _ctg_scratch matches 0 unless score L7E10Check _ctg_main matches 1.. unless entity @e[tag=_ctg_l7e1_rabbit1] run summon minecraft:rabbit 88.56 115.00 -61.66 {NoAI:1,Rotation:[-45f,5f],Tags:["_ctg_l7e1_rabbit1"],PersistenceRequired:1b}
execute if score Completed _ctg_scratch matches 0 unless score L7E10Check _ctg_main matches 1.. unless entity @e[tag=_ctg_l7e1_rabbit2] run summon minecraft:rabbit 93.03 115.00 -50.53 {NoAI:1,Rotation:[-90f,5f],Tags:["_ctg_l7e1_rabbit2"],PersistenceRequired:1b}
execute if score Completed _ctg_scratch matches 0 unless score L7E10Check _ctg_main matches 1.. unless entity @e[tag=_ctg_l7e1_rabbit3] run summon minecraft:rabbit 106.17 115.00 -60.91 {NoAI:1,Rotation:[45f,5f],Tags:["_ctg_l7e1_rabbit3"],PersistenceRequired:1b}
