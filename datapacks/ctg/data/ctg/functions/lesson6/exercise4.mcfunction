...
execute if score Lesson _ctg_main matches 6 if score Exercise _ctg_main matches 4 if score WeatherOn _ctg_scratch matches 0 if entity @p[predicate=ctg:thundering] run scoreboard players set Completed _ctg_scratch 1
