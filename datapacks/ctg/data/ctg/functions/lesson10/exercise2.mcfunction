...
# Description
execute if score Tick _ctg_main matches 1 run tellraw @a [{"text":"\n"},{"translate":"I've set a value to a name in that new 'fun' scoreboard of yours. Set your own score to the same value.", "color":"gold", "with": [{"translate": "Set your own score to the same value", "color": "green"}]}]

title @a actionbar [{"translate":"Set your 'fun' score to the same as the hidden score","color":"green"}]
