...
clone 23 127 18 23 127 18 1024 0 1025
clone 23 127 18 23 127 18 1024 0 1026
clone 23 127 18 23 127 18 1024 0 1027
clone 23 127 18 23 127 18 1024 0 1028
clone 23 127 18 23 127 18 1024 0 1029
clone 23 127 18 23 127 18 1024 0 1030
...
execute unless score SayCommand _ctg_scratch matches 1.. store success score SayCommand _ctg_scratch run data merge block 1024 0 1028 {"Command":"/say Hello world"}
execute unless score SayCommand _ctg_scratch matches 1.. store success score SayCommand _ctg_scratch run data merge block 1024 0 1029 {"Command":"/say Hello World"}
execute unless score SayCommand _ctg_scratch matches 1.. store success score SayCommand _ctg_scratch run data merge block 1024 0 1030 {"Command":"/say hello world"}
...
fill 1024 0 1025 1024 0 1030 minecraft:air
