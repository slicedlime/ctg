...
execute if entity @a[tag=_ctg_need_transition] run function ctg:lesson1/transition_setup
function ctg:transition
execute as @a[scores={_ctg_intro=0..}] run function ctg:lesson1/transition_spline
...
execute if score Tick _ctg_main matches 370.. if entity @a[tag=_ctg_transition_done] run function ctg:lesson1/intro_end
