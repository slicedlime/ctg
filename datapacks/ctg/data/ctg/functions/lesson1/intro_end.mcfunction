...
execute if score Lesson _ctg_main matches 1 if score Exercise _ctg_main matches 0 run setblock 26 128 24 minecraft:wall_sign[facing=north,waterlogged=false]{Text4:"{\"text\":\"start over\"}",Text3:"{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/function ctg:restart_exercise\"},\"text\":\"Click here to\"}",Text2:"{\"text\":\"\"}",Text1:"{\"text\":\"Island by Ximure!\"}"}
