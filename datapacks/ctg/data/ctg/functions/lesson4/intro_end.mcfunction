...
execute if score Lesson _ctg_main matches 4 if score Exercise _ctg_main matches 0 run setblock -15 114 31 minecraft:mangrove_wall_sign[facing=south,waterlogged=false]{Text4:'{"text":"start over"}',Text3:'{"clickEvent":{"action":"run_command","value":"/function ctg:restart_exercise"},"text":"Click here to"}',Text2:'{"text":"JochCool!"}',Text1:'{"text":"Island by"}',GlowingText:1b}
