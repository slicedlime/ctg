...
execute as @a[scores={_ctg_intro=0..}] run function ctg:lesson5/transition_spline
...
execute if score Tick _ctg_main matches 370.. if entity @a[tag=_ctg_transition_done] run function ctg:lesson5/intro_end
