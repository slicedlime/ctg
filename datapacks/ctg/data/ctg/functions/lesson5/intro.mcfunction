...
execute if score Tick _ctg_main matches 370.. unless entity @e[tag=_ctg_body] unless entity @a[tag=_ctg_need_transition] if entity @a run function ctg:lesson5/intro_end
